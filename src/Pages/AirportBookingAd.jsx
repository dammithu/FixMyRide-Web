    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="flex items-center justify-between px-8 py-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold">Smartzi</span>
        </div>
        <nav className="hidden md:flex space-x-6">
          <a href="#" className="text-green-500">AIRPORT TRANSFER</a>
          <a href="#" className="text-gray-600">LOCAL USE</a>
          <a href="#" className="text-gray-600">DRIVES</a>
          <a href="#" className="text-gray-600">BUSINESS</a>
        </nav>
        <div className="flex items-center space-x-4">
          <button className="text-gray-600">LOGIN</button>
          <button className="px-4 py-2 text-white bg-blue-600 rounded">SIGNUP</button>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-400">© 2025 Smartzi Inc.</p>
            </div>
            {[1, 2, 3].map((item) => (
              <div key={item} className="space-y-4">
