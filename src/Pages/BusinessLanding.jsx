  ...
  return (
    <div className="container mx-auto px-4 max-w-6xl text-center">
      ...
      <header className="py-12">
        <h1 className="text-4xl font-bold text-indigo-900">Lorem Ipsum Partners</h1>
      </header>
      ...
      <div className="grid md:grid-cols-2 gap-12 py-12">
        ...
        <div className="space-y-4 flex flex-col items-center">
          ...
          <p className="text-gray-600 leading-relaxed max-w-md">
            ...
            of passenger transport. Smartzi is created to give their drivers a fair 
            chance on creating their own customer network.
          </p>
          <button className="mt-4 px-6 py-2 border-2 border-indigo-900 text-indigo-900 rounded-full 
        ...
        <div className="space-y-4 flex flex-col items-center">
          <div className="flex items-center space-x-2">
            <div className="text-indigo-900 text-xl">📰</div>
            <h2 className="text-2xl font-semibold text-indigo-900">Latest News</h2>
          </div>
          <p className="text-gray-600 leading-relaxed max-w-md">
            Smartzi is a company that mediates between travelers and providers 
            of passenger transport. Smartzi is created to give their drivers a fair 
