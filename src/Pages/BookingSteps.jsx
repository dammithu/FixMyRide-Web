  ...
  const steps = [
    {
      ...
      description: 'Key in your pick-up and drop-off locations to get your estimated fare. Choose a car that fits your style and budget, then set your'
    },
    {
      number: 2,
      title: 'RIDE',
      icon: <Car className="w-12 h-12 text-blue-500" />,
      description: 'Smartzi will find you the nearest available driver. Know your driver\'s location and estimated time of arrival in real-time.'
    },
    {
      number: 3,
      title: 'PAY BY CARD OR CASH',
      icon: <CreditCard className="w-12 h-12 text-purple-500" />,
      description: 'You can pay for the trip by card or cash and rate your driver'
    }
  ];
          ...
          <React.Fragment key={step.number}>
            <div className="flex items-center">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center 
                ...
                <span className="text-gray-700 font-semibold">{step.number}</span>
              </div>
            </div>
